...
WALLPAPER_ALIASES = {
    "blackwater-river.png": ["ur beltze", "erreka", "ibaia", "defektuzko"],
    "blue.png": ["urdine"],
    "chukchi-sea.png": ["itsaso", "ozeano", "ure"],
    "earth-night.png": ["lurre", "gaue"],
    "green.png": ["berde"],
    "moon.png": ["ilargi"],
    "nebula.png": ["nebula", "espazio"],
    "orange.png": ["laranja"],
    "tokyo-night.png": ["hiri", "gaue"],
}
