...
from . import Wallpaper, WallpaperError
...
class HomescreenSkill(MycroftSkill):
    ...
    def __init__(self):
        ...
        # root_dir attribute does not handle Skill being loaded from submodule
        self.root_dir = dirname(dirname(abspath(sys.modules[self.__module__].__file__)))
